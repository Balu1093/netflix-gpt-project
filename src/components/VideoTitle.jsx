...
const VideoTitle = ({title,overview,id}) => {
  return (
    <div className='absolute flex flex-col justify-center h-screen text-white bg-gradient-to-r from-[rgba(0,0,0,1)] p-10 w-9/12'>
        <h1 className='text-3xl font-bold sm:text-4xl md:text-5xl 2xl:text-6xl'>{title}</h1>
        <h3 className='hidden text-1xl font-medium mt-3 w-6/12 md:block 2xl:block'>{overview}</h3>
