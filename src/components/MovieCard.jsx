...
const MovieCard = ({test,setTest,data}) => {
  ...
  return (
      <div>
        {discover && <ShowInfo test={test} setTest={setTest} props={setDiscover} data={data}/>}
      {data.poster_path? <div className='w-28 md:w-36 lg:w-52 hover:scale-90 rounded-lg transition duration-300'>
