...
const YoutubeVideo = ({data,toggle,youtube}) => {
  ...
  return (
    <div className='bg-transparent fixed w-[100%] h-[100%] top-0 left-0 right-0 bottom-0 z-10 text-white'>
        <div className='absolute bg-[rgba(49,49,49,0.7)] w-[500px] h-[900px] sm:w-[600px] sm:h-[900px] md:w-[800px] md:h-[900px] lg:w-[1000px] lg:h-[900px] 2xl:w-[1550px] 2xl:h-[900px] top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 py-4 px-4 min-w-[450px] min-h-[500px] max-h-[900px] max-w-[1550px]'>
