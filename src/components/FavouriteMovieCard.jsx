...
return (
      <div>
      <div className='relative w-52 rounded-lg transition duration-300 group'>
      <img className='w-full h-full rounded-lg cursor-pointer ' src={Image_CDN+data.poster_path} alt="" />
