...
const YoutubeVideo = ({data,setyoutube,youtube}) => {
  ...
  return (
    <div className='bg-transparent fixed w-[100%] mx-auto h-[100%] top-0 left-0 right-0 bottom-0 z-10 text-white'>
        ...
        <iframe className='w-[400px] h-[700px] sm:w-full sm:h-full mx-auto mt-10 md:mt-0 rounded-lg' src={"https://www.youtube.com/embed/"+data?.key+"?rel=0&autoplay=1&mute=1&autohide=1&showinfo=0&controls=1"} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin"allowFullScreen></iframe>
        <div className=''>
       <button className='absolute text-white top-[12%] md:top-[10%] end-0 right-4 md:right-2 mr-5 py-2 px-2 font-medium text-xl bg-white rounded-full bg-opacity-40' onClick={toggleOption}> <IoCloseSharp/></button>
      </div>
        </div>
        </div>
  )
